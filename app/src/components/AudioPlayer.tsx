...
function VoicePickerModal({
  ...
  return (
    ...
    >
      <div
        className="flex max-h-[80vh] w-full max-w-6xl flex-col overflow-hidden rounded-t-lg border border-[var(--reader-rule)] bg-[var(--reader-surface)] shadow-xl sm:rounded-lg"
