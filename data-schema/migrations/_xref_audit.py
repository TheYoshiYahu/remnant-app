...
COVERAGE_GLOBS = ['session1*matt*extras_cross_references.sql',
    ...
    'session2*_romans_cross_references.sql',
    'session2*_hebrews_cross_references.sql',
    'session2*_galatians_cross_references.sql',
    'session2*_revelation_cross_references.sql',
    ...
    'session2*_1thessalonians_cross_references.sql',
    'session2*_2thessalonians_cross_references.sql',
    'session2*_1timothy_cross_references.sql',
    'session2*_2timothy_cross_references.sql',
    'session2*_titus_cross_references.sql',
    ...
    'session2*_1john_cross_references.sql',
    'session2*_2john_cross_references.sql',
    'session2*_3john_cross_references.sql',
    'session2*_jude_cross_references.sql',
    'session2*_*_depth_cross_references.sql',
