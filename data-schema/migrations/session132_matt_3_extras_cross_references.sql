...
WITH input(src_edition, src_slug, src_ch, src_v,
  ...
  ('canon', 'matthew', 3, 17, 'ascension-isaiah', 'ascension-isaiah', 9, 12,
   '*Crowns and thrones of glory they do not receive, till the Beloved will descend in the form in which you will see Him descend will descend, I say into the world in the last days Yahuah (Lord), who will be called Messiah.* Ascension of Isaiah 9:12 names the Beloved''s descent in human form — the same Beloved Father-voice names at Matt 3:17. The Ascension preserves the architecture: the Father commissions the Beloved''s descent; the Formed takes on flesh; the public investiture at the water is the manifestation of the prior heavenly designation.'),
