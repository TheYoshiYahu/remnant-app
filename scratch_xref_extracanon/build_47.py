...
data = {
  ...
  "threads": [
    {
      "slug": "1-adam-eve-47-fear-of-death-and-the-promise",
      "title": "The fire, the fear of death, and the longing for the promise",
      "summary_md": "Scorched by the fire, Adam stares past this world into the next and cries for the only deliverance there is — that Elohim should come and keep His word: *\"Look, the fire has burnt our flesh in this world; but how will it be when we are dead, and Satan shall punish our souls? Is not our deliverance long and far off, unless Elohim (God) come, and in mercy to us fulfil His promise?\"* (1 Adam and Eve 47:2). It ain't new: the dread of death and the hope hung on a single Promise is the spine of the whole Book. The promise Adam clings to is the seed-promise spoken over the serpent the day they fell — *And I will put enmity between thee and the woman, and between thy seed and her seed; it shall bruise thy head, and thou shalt bruise his heel.* (Genesis 3:15). Death is the reign Adam fears, and Paul names how it came and how it ends — *Wherefore, as by one man sin entered into the world, and death by sin; and so death passed upon all men, for that all have sinned:* (Romans 5:12). And the \"unless Elohim come\" is answered in the fulness of time — *But when the fulness of the time was come, Elohim (God) sent forth his Son, made of a woman, made under the law,* (Galatians 4:4) — the very One who came to break the power Adam dreads — *that through death he might destroy him that had the power of death, that is, the devil;* (Hebrews 2:14).",
      "anchor_start_v": 1,
      "anchor_end_v": 4,
      "tier": "extras",
      "members": [
        {"src_ch": 47, "src_v": 2, "tgt_edition": "canon", "tgt_book": "genesis", "tgt_ch": 3, "tgt_v": 15, "tier": "free",
         "note": "Genesis 3:15 — *And I will put enmity between thee and the woman, and between thy seed and her seed; it shall bruise thy head, and thou shalt bruise his heel.* The \"promise\" Adam begs Elohim to fulfil is this seed-word, the only deliverance from the Satan he fears in 1 Adam and Eve 47:2."},
        {"src_ch": 47, "src_v": 2, "tgt_edition": "canon", "tgt_book": "romans", "tgt_ch": 5, "tgt_v": 12, "tier": "free",
         "note": "Romans 5:12 — *Wherefore, as by one man sin entered into the world, and death by sin; and so death passed upon all men, for that all have sinned:* Paul traces the very death Adam dreads in 1 Adam and Eve 47:2 back to the one man's fall outside whose cave this scene is set."},
        {"src_ch": 47, "src_v": 2, "tgt_edition": "canon", "tgt_book": "galatians", "tgt_ch": 4, "tgt_v": 4, "tier": "free",
         "note": "Galatians 4:4 — *But when the fulness of the time was come, Elohim (God) sent forth his Son, made of a woman, made under the law,* This is the answer to Adam's \"unless Elohim come\" in 1 Adam and Eve 47:2 — the promised coming made flesh in due time."},
        {"src_ch": 47, "src_v": 2, "tgt_edition": "canon", "tgt_book": "hebrews", "tgt_ch": 2, "tgt_v": 14, "tier": "free",
    ...
    },
    {
      ...
      "members": [
        ...
        {"src_ch": 47, "src_v": 8, "tgt_edition": "canon", "tgt_book": "genesis", "tgt_ch": 4, "tgt_v": 8, "tier": "free",
         "note": "Genesis 4:8 — *And Cain talked with Abel his brother: and it came to pass, when they were in the field, that Cain rose up against Abel his brother, and slew him.* Satan's design to leave no seed to inherit the kingdom (1 Adam and Eve 47:8) is first carried out through Cain, who murders the righteous brother."},
        {"src_ch": 47, "src_v": 7, "tgt_edition": "canon", "tgt_book": "ezekiel", "tgt_ch": 28, "tgt_v": 15, "tier": "free",
         "note": "Ezekiel 28:15 — *Thou wast perfect in thy ways from the day that thou wast created, till iniquity was found in thee.* Satan's grievance over \"the kingdom in which I once was\" in 1 Adam and Eve 47:7 echoes this fall of the once-perfect anointed one."},
        {"src_ch": 47, "src_v": 7, "tgt_edition": "enoch", "tgt_book": "1-enoch", "tgt_ch": 69, "tgt_v": 10, "tier": "extras",
         "note": "1 Enoch 69:10 — *And the third was named Gâdreêl: he it is who showed the children of men all the blows of death, and he led astray Eve, and showed [the weapons of death to the sons of men] the shield and the coat of mail, and the sword for battle, and all the weapons of death to the children of men.* The same envy that now plots Adam's death in 1 Adam and Eve 47:7 first led Eve astray and brought the blows of death into the world."}
      ]
    }
  ]
}

with open("/tmp/extracanon-xref-wt/scratch_xref_extracanon/json_1_adam_eve_47.json", "w") as f:
