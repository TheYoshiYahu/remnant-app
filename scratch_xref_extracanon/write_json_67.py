  ...
  "threads": [
    {
      ...
      "members": [
        ...
        {"src_ch": 67, "src_v": 3, "tgt_edition": "canon", "tgt_book": "1-peter", "tgt_ch": 5, "tgt_v": 8, "tier": "free",
         "note": "1 Peter 5:8 — *Be sober, be vigilant; because your adversary the devil, as a roaring lion, walketh about, seeking whom he may devour.* Satan's scheme to slay Adam and Eve by hunger and thirst (1 Adam and Eve 67:3) is the devouring adversary at his oldest work."}
      ]
    },
    {
      "slug": "1-adam-eve-67-angels-of-light-deception",
      "title": "Satan and his hosts as praising angels — transformed into an angel of light",
      "summary_md": "Going up wounded from the burned field, Adam and Eve are met by the enemy in disguise: *Satan and his hosts met them in the form of angels, praising Elohim (God)* (1 Adam and Eve 67:8). With false comfort the deceiver lies, *Come back with us; we are angels of Elohim (God). Elohim (God) sent us to you, to show you another field of corn, better than that; and beyond it is a fountain of good water* (1 Adam and Eve 67:10). This is the apostle's exact unmasking: *Satan himself is transformed into an angel of light* (2 Corinthians 11:14), and the serpent who *beguiled Eve through his subtilty* (2 Corinthians 11:3) is here at it again. He is the liar by nature — *He was a murderer from the beginning, and abode not in the truth... for he is a liar, and the father of it* (John 8:44) — *that old serpent, called the Devil, and Satan, which deceiveth the whole world* (Revelation 12:9).",
      "anchor_start_v": 8, "anchor_end_v": 11, "tier": "extras",
      "members": [
        {"src_ch": 67, "src_v": 8, "tgt_edition": "canon", "tgt_book": "2-corinthians", "tgt_ch": 11, "tgt_v": 14, "tier": "free",
         "note": "2 Corinthians 11:14 — *And no marvel; for Satan himself is transformed into an angel of light.* Satan and his hosts meeting Adam and Eve in the form of angels praising Elohim (1 Adam and Eve 67:8) is the very transformation the apostle warns of."},
        {"src_ch": 67, "src_v": 10, "tgt_edition": "canon", "tgt_book": "john", "tgt_ch": 8, "tgt_v": 44, "tier": "free",
        ...
        {"src_ch": 67, "src_v": 8, "tgt_edition": "canon", "tgt_book": "revelation", "tgt_ch": 12, "tgt_v": 9, "tier": "free",
        ...
        {"src_ch": 67, "src_v": 11, "tgt_edition": "canon", "tgt_book": "2-corinthians", "tgt_ch": 11, "tgt_v": 3, "tier": "free",
         "note": "2 Corinthians 11:3 — *But I fear, lest by any means, as the serpent beguiled Eve through his subtilty, so your minds should be corrupted from the simplicity that is in Messiah (Christ).* Adam thinking the deceivers true and going back with them (1 Adam and Eve 67:11) is Eve beguiled through subtilty once more."}
      ]
    },
    {
      "slug": "1-adam-eve-67-led-astray-to-deny-elohim",
      "title": "Driven by hunger and thirst that they might deny Elohim",
      "summary_md": "The enemy's whole aim is named: that worn down by hunger and thirst, *they die of hunger and thirst; when they may, perhaps, deny Elohim (God), and He destroy them* (1 Adam and Eve 67:4) — and so *Satan began to lead astray Adam and Eve eight days, until they both fell down as if dead, from hunger, thirst, and faintness* (1 Adam and Eve 67:12). It is the tempter's same lever pressed against the Second Adam in the wilderness — *And when the tempter came to him, he said, If thou be the Son of Elohim (God), command that these stones be made bread* (Matthew 4:3) — yet the deceiver who poured out their water cannot give the true drink, for only the Word gives *a well of water springing up into everlasting life* (John 4:14). And the promise stands over every assault: *And the Elohim (God) of peace shall bruise Satan under your feet shortly* (Romans 16:20).",
      "anchor_start_v": 4, "anchor_end_v": 12, "tier": "extras",
      "members": [
        {"src_ch": 67, "src_v": 4, "tgt_edition": "canon", "tgt_book": "matthew", "tgt_ch": 4, "tgt_v": 3, "tier": "free",
         "note": "Matthew 4:3 — *And when the tempter came to him, he said, If thou be the Son of Elohim (God), command that these stones be made bread.* The plan to break Adam and Eve by hunger until they deny Elohim (1 Adam and Eve 67:4) is the same hunger-lever the tempter pressed against the Son in the wilderness."},
        {"src_ch": 67, "src_v": 4, "tgt_edition": "canon", "tgt_book": "john", "tgt_ch": 4, "tgt_v": 14, "tier": "free",
         "note": "John 4:14 — *But whosoever drinketh of the water that I shall give him shall never thirst; but the water that I shall give him shall be in him a well of water springing up into everlasting life.* Satan empties their bottle of water to kill them with thirst (1 Adam and Eve 67:4), but the Word alone gives the water that quenches forever."},
        {"src_ch": 67, "src_v": 12, "tgt_edition": "canon", "tgt_book": "romans", "tgt_ch": 16, "tgt_v": 20, "tier": "free",
         "note": "Romans 16:20 — *And the Elohim (God) of peace shall bruise Satan under your feet shortly. The grace of our Lord Yahusha HaMashiach (Lord Jesus Christ) be with you. Amen.* Though Satan leads them astray eight days and leaves them as dead (1 Adam and Eve 67:12), the seed-promise guarantees Satan bruised under the feet of the redeemed."}
      ]
    }
  ]
}

with open("/tmp/extracanon-xref-wt/scratch_xref_extracanon/json_1_adam_eve_67.json", "w") as f:
