...
**Translation:** Roberts-Donaldson, *Ante-Nicene Fathers* vol. 7 (1867). Public domain.
**Source URL:** http://www.earlychristianwritings.com/text/didache-roberts.html (fetched 2026-05-11)
**Cepher reference name:** YARAH H'ASGAR SHENIYM (in Ha'avoth collection)
...
**Status:** Pre-restoration raw text on disk. Pipeline restoration (Yahuah / Yahusha / Yashar'el / Yahudim / etc.) to run when the pipeline is wired to ingest this folder.

**Note on the chapter 16 "world-deceiver as Son of God" line:** matches the framework reading of the antichrist system. Document this for the pipeline's commentary attachment when commentary work begins.
